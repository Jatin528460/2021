...
function returnback(){
    ...
    document.getElementById('door').src = 'gate.png';   
...
function vipreturnback(){
    ...
    document.getElementById('vipdoor').src = 'gate.png';  
    document.getElementById('arrowid21').style.display='none';
    name="";
    random="";
    special="";
...
function vipspecial(){
    ...
    if(special == 'monu'){
        ...
        document.getElementById('sampletxt2id21').innerHTML='';
    ...
    if(special == 'swati'){
        ...
        document.getElementById('sampleduo1id21').src='swati 1.png';
        document.getElementById('sampleduo2id21').src='swati 2.png';
        document.getElementById('sampleduo3id21').src='swati 3.png';
    ...
    if(special == 'anjali'){
        ...
        document.getElementById('sampleduo1id21').src='anjali 1.png';
        document.getElementById('sampleduo2id21').src='anjali 2.png';
        document.getElementById('sampleduo3id21').src='anjali 3.png';
    ...
    if(special == 'avinash'){
        ...
        document.getElementById('sampleduo1id21').src='avinash 1.png';
        document.getElementById('sampleduo2id21').src='avinash 2.png';
        document.getElementById('sampleduo3id21').src='avinash 3.png';
...
function jatin(){
    ...
    document.getElementById('sampleduo1id').src='jatin 1.png';
    document.getElementById('sampleduo2id').src='jatin 2.png';
    document.getElementById('sampleduo3id').src='jatin 3.png';
